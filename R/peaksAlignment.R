...
## peaksAlignment <- function(d1, d2, t1, t2, D=1000, timedf=NULL,
##                            gap=.5, df=30, w=25, mzind=24, metric=1, transform="none",
##                            verbose=TRUE, usePeaks=TRUE, compress=TRUE){
peaksAlignment <- function(d1, d2, t1, t2, gap=.5, D=1000,
                           timedf=NULL, df=30, verbose=TRUE,
                           usePeaks=TRUE, compress=TRUE){
